...
from .views import (StaffsListViewSet, TweetsListViewSet, PrizesListViewSet, PastAICsListViewSet, FAQListViewSet,
                    NewsListViewSet, NewsTagListViewSet, TimelineEventListViewSet, StatisticViewSet, UTMTrackerViewSet)
...
website_router.register(r'utm-tracker', UTMTrackerViewSet, basename='utm-tracker_api')
